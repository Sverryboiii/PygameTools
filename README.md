# Sverrys PygameTools
Sverrys PygameTools is a wrapper for the library "pygame" that adds a basic runtime and UI.runtime functions named "frame" and "tick":
...
This will install all the file from the directory `SverrysPygameTools`.
